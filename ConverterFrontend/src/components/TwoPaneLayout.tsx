    ...
    <div className="w-full h-[calc(100vh-80px)]">
      <div className="w-full h-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-full">
          {/* Left Pane - Preview */}
          <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-xl border border-white/20 p-4 h-full">
            <h2 className="text-xl font-semibold mb-3 pb-2 border-b border-white/20 flex items-center">
