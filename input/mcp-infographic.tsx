...
const MCPExplanation = () => {
  // Custom styles based on Patrick's styleguide
  const containerStyle = "bg-white text-gray-800 p-6 shadow-lg";
  ...
  const Circle = ({ children, bgColor = "bg-indigo-50", size = "w-16 h-16", extraClasses = "" }) => (
      ...
      <div className={sectionStyle}>
        ...
        <div className="p-4 bg-indigo-50/50 rounded-lg">
          <div className="flex flex-col items-center">
            {/* Static Diagram Image - Not responsive dependent */}
  ...
  "emails": [
    ...
    { "subject": "Project Resources", "date": "2025-03-22" }
      ...
      <div className={sectionStyle}>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          <div className={cardStyle + " bg-gradient-to-b from-white to-indigo-50/20"}>
